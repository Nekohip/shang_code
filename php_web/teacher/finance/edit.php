            ...
            <form action="insert_edit.php" method="post">
                ...
                <div class="form-section">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="item" name="item" placeholder="例：咖啡、午餐" value="<?= $exp['item']?>" required>
                    </div>
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="number" id="payment" name="payment" placeholder="0.00" step="0.01" min="0" value="<?=$exp['payment']?>" required>
                        </div>
                        <div class="form-group">
